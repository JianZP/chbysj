        ...
        <div class="layui-side-scroll">
          ...
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            <li data-name="home" class="layui-nav-item layui-nav-itemed">
              ...
              <dl class="layui-nav-child">
                <dd data-name="console" class="layui-this">
                  <a lay-href="/views/home/console.html">用户权限管理</a>
                </dd>
              </dl>
            </li>
            <li data-name="component" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                <dd data-name="button">
                  <a lay-href="/views/component/button/index.jsp">设备类型信息管理</a>
                </dd>
              </dl>
            </li>
            <li data-name="template" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                <dd><a lay-href="/views/template/personalpage.jsp">设备信息管理</a></dd>
              </dl>
            </li>
            <li data-name="app" class="layui-nav-item">
              <a href="javascript:;" lay-tips="设备状态管理" lay-direction="2">
                <i class="layui-icon layui-icon-app"></i>
                <cite>设备状态管理</cite>
              </a>
              <dl class="layui-nav-child">
                <dd>
                  <a lay-href="/views/app/message/status.jsp">设备状态管理</a>
                </dd>
              </dl>
            </li>
            <li data-name="senior" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                <dd>
                  <a lay-href="/views/home/logmanage.jsp">日志管理</a>
                </dd>
              </dl>
            </li>
          </ul>
